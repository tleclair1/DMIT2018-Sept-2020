...
<div>
    ...
    <div class="col-sm-2">
        ...
        <asp:DropDownList ID="MediaTypeDDL" runat="server"
            Width="150px" DataSourceID="MediaDDLODS" DataTextField="DisplayText" DataValueField="ValueId">
        </asp:DropDownList><br />
        ...
        <asp:DropDownList ID="GenreDDL" runat="server"
            Width="150px" DataSourceID="GenreDDLODS" DataTextField="DisplayText" DataValueField="ValueId">
        </asp:DropDownList><br />
    ...
    <div class="col-sm-10">
                ...
                <tr style="background-color: #FFFFFF; color: #284775;">
                    <td>
                        <asp:LinkButton ID="AddtoPlaylist" runat="server"
                            ...
                            &nbsp;&nbsp;<i class="fa fa-plus" style="color:limegreen; font-size:2em;"></i>&nbsp;
        ...
        <asp:LinkButton ID="DeleteTrack" runat="server"
            ...
            <i class="fa fa-trash-o" style="color:red; font-size:2em;"></i>
...
<%-- Add ODSs for dropdownlists --%>
    ...
    <asp:ObjectDataSource ID="GenreDDLODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="List_GenreNames" TypeName="ChinookSystem.BLL.GenreController" OnSelected="SelectCheckForException"></asp:ObjectDataSource>
